const tenants = {
  ...
  members: {
    ...
    console_operators: {
      description:
        '控制台操作员可使用各自凭据登录本 Logto 控制台，并通过 Management API 管理 default 租户（权限与首位管理员一致）。',
      create_button: '添加控制台操作员',
      table_user: '用户',
      table_roles: '角色',
      empty: '暂无控制台操作员。',
      modal_title: '添加控制台操作员',
      field_primary_email: '主邮箱',
      field_password: '密码',
      field_username: '用户名（可选）',
      field_name: '显示名称（可选）',
      create_submit: '创建',
      delete_action: '移除',
      delete_title: '移除控制台操作员',
      delete_description: '该用户将从管理租户中删除，且无法再登录 Logto 控制台。',
      created_success: '已创建控制台操作员。',
      deleted_success: '已移除控制台操作员。',
    },
  },
  settings: {
    title: '设置',
